...
function reviews(opts) {
  return new Promise(function (resolve, reject) {
    ...
    const fullOptions = Object.assign({
      ...
      aggregate: constants.aggregate.ALL,
      lang: 'en',
      country: 'us',
      num: 150,
      paginate: false,
...
function getBodyForRequests({
  ...
  aggregate = aggregate === 0 ? `%5Bnull%2C${aggregate}%2Cnull%2Cnull%2Cnull%2Cnull%2Cnull%2Cnull%2C2%5D` : 'null';
  /* The body is slight different for the initial and paginated requests */
  const formBody = {
    [REQUEST_TYPE.initial]: `f.req=%5B%5B%5B%22UsvDTd%22%2C%22%5Bnull%2Cnull%2C%5B2%2C${sort}%2C%5B${numberOfReviewsPerRequest}%2Cnull%2Cnull%5D%2C${aggregate}%2C%5B%5D%5D%2C%5B%5C%22${appId}%5C%22%2C7%5D%5D%22%2Cnull%2C%22generic%22%5D%5D%5D`,
    [REQUEST_TYPE.paginated]: `f.req=%5B%5B%5B%22UsvDTd%22%2C%22%5Bnull%2Cnull%2C%5B2%2C${sort}%2C%5B${numberOfReviewsPerRequest}%2Cnull%2C%5C%22${withToken}%5C%22%5D%2C${aggregate}%2C%5B%5D%5D%2C%5B%5C%22${appId}%5C%22%2C7%5D%5D%22%2Cnull%2C%22generic%22%5D%5D%5D`
  };
